package com.vic.villz.gsontutorial.adapter;
...
import com.vic.villz.gsontutorial.helper.CircleTransform;
import com.vic.villz.gsontutorial.helper.FlipAnimator;
...
public class MessagesAdapter extends RecyclerView.Adapter<MessagesAdapter.MyViewHolder> {
    ...
    public void toggleSelection(int pos) { //linked with getSelectedItemCount
        currentSelectedIndex = pos;
        if (selectedItems.get(pos, false)) { //if this item already exists then delete
            selectedItems.delete(pos);
            animationItemsIndex.delete(pos);
        } else {
            selectedItems.put(pos, true); //create a new array element with selected value to true
    ...
    public int getSelectedItemCount() { //linked with toggleSelection
